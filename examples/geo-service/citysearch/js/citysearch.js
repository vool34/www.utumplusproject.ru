$.holdReady(true);
$.getScript(((window.location.protocol == 'file:') ? "http:" : window.location.protocol) + "//api.backendless.com/sdk/js/latest/backendless.min.js",
    function() {
        $.holdReady(false);
        ...
        function onResult(result) {
            ...
            $.each(result.data, function() {
                var cells = [
                    "<td>" + this.metadata.city + "</td>", "<td>" + this.latitude + "</td>",
